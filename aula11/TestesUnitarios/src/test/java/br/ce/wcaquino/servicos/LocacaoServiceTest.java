...
public class LocacaoServiceTest {
	...
	public void beforeMethod() {
		contadorTestes++;
		System.out.println("Número de testes realizados: " + contadorTestes);
	...
	public void testeLocacao_filmeSemEstoque_elegante() throws Exception {
		...
		System.out.println("testeLocacao_filmeSemEstoque_elegante()");
	...
	public void testeLocacao_filmeSemEstoque_robusta()  {
		...
		System.out.println("testeLocacao_filmeSemEstoque_robusta()");
	...
	public void testeLocacao_filmeSemEstoque_nova() throws Exception {
		...
		System.out.println("testeLocacao_filmeSemEstoque_nova()");
