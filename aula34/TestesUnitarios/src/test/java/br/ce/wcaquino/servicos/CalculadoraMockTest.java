...
public class CalculadoraMockTest {
	 ...
	 * Porém, nos testes que realizei tanto o Mock quanto o Spy causaram a chamada efetiva ao método somar. E isso aconteceu tanto com o uso de when quanto com o uso de doReturn.
	 * Tudo indica que isso foi alterado na versão do Mockito que estou usando. Ela é diferente da utilizada no curso porque eu estava tendo erros de execução com o Java 11.
	 */
	@Test
